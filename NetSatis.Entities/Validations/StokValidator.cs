...
namespace NetSatis.Entities.Validations
{
    public class StokValidator:AbstractValidator<Stok>
    {
        public StokValidator()
        {
            ...
            RuleFor(p => p.SatisFiyati1).GreaterThan(0).WithMessage("Satış Fiyatı - 1 alanı 0'dan büyük olmalıdır. ");
            RuleFor(p => p.SatisFiyati2).GreaterThan(0).WithMessage("Satış Fiyatı - 2 alanı 0'dan büyük olmalıdır. ");
            RuleFor(p => p.SatisFiyati3).GreaterThan(0).WithMessage("Satış Fiyatı - 3 alanı 0'dan büyük olmalıdır. ");
