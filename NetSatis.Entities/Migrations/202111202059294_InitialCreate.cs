        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        VergiDairesi = c.String(maxLength: 20),
                        VergiNo = c.String(maxLength: 20),
                        IskontoOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                        RiskLimiti = c.Decimal(nullable: false, precision: 12, scale: 2),
                        AlisOzelFiyati = c.String(maxLength: 30),
                        SatisOzelFiyati = c.String(maxLength: 30),
                ...
                c => new
                    {
                        ...
                        FisTuru = c.String(maxLength: 20),
                        CariTuru = c.String(maxLength: 20),
                        CariKodu = c.String(maxLength: 15),
                        CariAdi = c.String(maxLength: 50),
                        BelgeNo = c.String(maxLength: 15),
                        Tarih = c.DateTime(nullable: false),
                        PlasiyerKodu = c.String(maxLength: 15),
                        PlasiyetAdi = c.String(maxLength: 30),
                        IskontoOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        FisKodu = c.String(maxLength: 20),
                        Hareket = c.String(maxLength: 20),
                        KasaKodu = c.String(maxLength: 20),
                        KasaAdi = c.String(maxLength: 50),
                        OdemeTuruKodu = c.String(maxLength: 20),
                        OdemeTuruAdi = c.String(maxLength: 50),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        OdemeTuruKodu = c.String(maxLength: 30),
                        OdemeTuruAdi = c.String(maxLength: 50),
                        Aciklama = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        FisKodu = c.String(maxLength: 20),
                        Hareket = c.String(maxLength: 30),
                        StokKodu = c.String(maxLength: 20),
                        StokAdi = c.String(maxLength: 50),
                        BarkodTuru = c.String(maxLength: 30),
                        Barkod = c.String(maxLength: 30),
                        Birimi = c.String(maxLength: 30),
